...
class SessionizerSuite extends FunSuite {
  ...
  test("Cut by timeout") {
    ...
    val testingSeq = Seq(
      Normalized(batchTimeInTs + 1, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 2, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 3, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 4, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 5 + 20 * 60 + 1, "1.1.1.1:0", "", "1.1.1.1:0"),// <--- should cut here
      Normalized(batchTimeInTs + 6 + 20 * 60 + 1, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 7 + 20 * 60 + 1, "1.1.1.1:0", "", "1.1.1.1:0")
    )
  ...
  test("Cut by timeout with pending") {
    ...
    val testingSeq = Seq(
      ...
      Normalized(batchTimeInTs + 3, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 4, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 5 + 40 * 60 + 1, "1.1.1.1:0", "", "1.1.1.1:0"),// <--- should cut here
      Normalized(batchTimeInTs + 6 + 40 * 60 + 1, "1.1.1.1:0", "", "1.1.1.1:0"),
      Normalized(batchTimeInTs + 7 + 40 * 60 + 1, "1.1.1.1:0", "", "1.1.1.1:0")
    )
  ...
  test("Cut by max duration") {
    ...
    val testingSeq = (1 to 26) map (x => Normalized(batchTimeInTs - 6 * 60 * 60 + x * 15 * 60, "1.1.1.1:0", "", "1.1.1.1:0"))
  ...
  test("Cut by max duration with pending") {
    ...
    val testingSeq = (1 to 27) map (x => Normalized(batchTimeInTs - 6 * 60 * 60 + x * 15 * 60, "1.1.1.1:0", "", "1.1.1.1:0"))
